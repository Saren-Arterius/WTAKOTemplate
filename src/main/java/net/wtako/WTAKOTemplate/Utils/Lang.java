...
public enum Lang {
    ...
    HELP_EXAMPLE("Type &b/" + Main.getInstance().getProperty("mainCommand")
            + " &a{0}&f to see a subcommand example. {1}"),
    HELP_EXAMPLE_HI("Type &b/" + Main.getInstance().getProperty("mainCommand") + " &a{0}&f to see a 'hi' message. {1}"),
